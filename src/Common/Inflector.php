...
/**
 * This inflector has static methods for inflecting text.
 *
 * The methods in these classes are from several different sources collected
 * across several different php projects and several different authors. The
 * original author names and emails are not known.
 *
 * This class borrowed from the Doctrine Inflector project, with some modifications
 *
 * @license MIT
 */
class Inflector
{
    ...
    /**
     * Converts a word or class name into the format for a table name.
     * Converts 'ModelName' or 'MyNamespace\ModelName' to 'model_name'
     *
    ...
    {
        $path = (str_replace('\\', DIRECTORY_SEPARATOR, $word));
        return strtolower(preg_replace('~(?<=\\w)([A-Z])~', '_$1', $word != $path ? basename($path) : $word));
    }

    /**
     * Converts a word into the format for a Model class name. Converts 'table_name' to 'TableName'.
     *
